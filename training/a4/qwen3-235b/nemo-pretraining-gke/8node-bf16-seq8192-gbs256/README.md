<!-- mdformat global-off -->
# Pretrain Qwen3 235B MoE workloads on a4 GKE Node pools with Nvidia NeMo Framework

This recipe outlines the steps for running a Qwen3 235B MoE pretraining
...
```
kubectl get pods | grep $USER-a4-qwen3-235b-moe
```

Replace the following:

- JOB_NAME_PREFIX - your job name prefix. For example $USER-a4-qwen3-235b-moe
...
For example: `$USER-a4-qwen3-235b-moe-workload-0-0-s9zrv`.
...
```bash
helm uninstall $USER-a4-qwen3-235b-moe
```
