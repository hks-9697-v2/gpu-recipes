...
def recipe(
  ...
  """Returns a Nemo2 training recipe for Qwen3 235B MoE model.
  ...
  """
  # Start from the Qwen3 standard recipe.
  ...
  # Model Config Fusions from Slurm example
  ...
  # Recompute Args from Slurm example
  ...
  # Callbacks from Slurm example
  pretrain.trainer.callbacks.append(run.Config(MegatronTokenDropCallback))
  pretrain.trainer.callbacks.append(run.Config(MegatronCommOverlapCallback, tp_comm_overlap=True))
